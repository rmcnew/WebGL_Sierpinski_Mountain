...
//
//  MV.js
//  Original version by Edward Angel
//  Modifications and additions by Richard McNew
//
//////////////////////////////////////////////////////////////////////////////
...
//----------------------------------------------------------------------------
function perturb( a, size, factor ) {
    var x;
    var y;
    var z;
    if (Math.random() > 0.5) {
        x = a[0] + Math.random() * size * factor;
    } else {
        x = a[0] - Math.random() * size * factor;
    }
    if (Math.random() > 0.5) {
        y = a[1] + Math.random() * size * factor;
    } else {
        y = a[1] - Math.random() * size * factor;
    }
    if (Math.random() > 0.5) {
        z = a[2] + Math.random() * size * factor;
    } else {
        z = a[2] - Math.random() * size * factor;
    }
    return vec3(x, y, z);
